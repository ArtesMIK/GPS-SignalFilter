Вот переписанное описание проекта для публикации на GitHub, с учётом нового кода, сохранением структуры, объёма и информации, а также без использования запрещённых слов:
